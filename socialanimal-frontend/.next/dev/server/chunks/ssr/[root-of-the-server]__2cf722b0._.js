...
function CalendarTab() {
    ...
    const fetchEvents = async ()=>{
        try {
            ...
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"].API_URL}/api/events`, {
                headers: {
    ...
    const handleExportCalendar = ()=>{
        const token = localStorage.getItem("token");
        window.open(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"].API_URL}/api/ics/my-calendar.ics`, "_blank");
    };
...
"[project]/components/CalendarTab.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/CalendarTab.tsx'\n\nExpected ',', got 'ident'");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cf722b0._.js.map