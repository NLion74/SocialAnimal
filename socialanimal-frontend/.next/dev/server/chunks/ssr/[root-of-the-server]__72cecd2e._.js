...
function FriendsTab() {
    ...
    const handleAcceptFriend = async (friendshipId)=>{
        try {
            const token = localStorage.getItem("token");
            const response = await fetch(`http://localhost:3000/api/friends/${friendshipId}/accept`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`
                }
    ...
    const handleRemoveFriend = async (friendshipId)=>{
        try {
            const token = localStorage.getItem("token");
            const response = await fetch(`http://localhost:3000/api/friends/${friendshipId}`, {
                method: "DELETE",
                headers: {
                    Authorization: `Bearer ${token}`
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72cecd2e._.js.map