...
function FriendsTab() {
    ...
    const handleAcceptFriend = async (friendshipId)=>{
        try {
            const token = localStorage.getItem("token");
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"].API_URL}/api/friends/${friendshipId}/accept`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`
                }
    ...
    const handleRemoveFriend = async (friendshipId)=>{
        try {
            const token = localStorage.getItem("token");
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"].API_URL}/api/friends/${friendshipId}`, {
                method: "DELETE",
                headers: {
                    Authorization: `Bearer ${token}`
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee77fbe9._.js.map